const creds = [
  {
    ...
    desc: "MIT Graduate Certificate in Supply Chain & Logistics. Senior leadership roles across EMEA and LATAM at FMC, Bayer, and UPL. Real environments, real constraints, real results — not theoretical frameworks.",
  },
  {
    title: "Faster and leaner than big firms",
    desc: "6 weeks, not 6 months. Direct access to a senior practitioner from day one. Lower cost at the same strategic quality. No recycled slide decks — everything built for your specific context.",
  },
  {
    title: "AI-powered delivery",
    desc: "We leverage the latest AI tools for demand sensing, intelligent exception prioritisation, and dynamic inventory optimisation — embedded into your process as a practical accelerator, not sold as a separate product.",
  },
];

export default function Credentials() {
  return (
    <section id="why" className="py-24 px-16 bg-navy">
